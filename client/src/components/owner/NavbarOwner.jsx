        ...
        <div className='sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur'>
            <div className='flex items-center justify-between px-5 py-4 md:px-8'>
                <div className='flex min-w-0 items-center gap-4'>
                    ...
                    <div className='hidden min-w-0 md:block'>
                        ...
                        <p className='whitespace-nowrap text-base font-semibold text-slate-900'>{pageNames[location.pathname] || 'Owner Panel'}</p>
                    </div>
                </div>
                ...
                <div className='flex shrink-0 items-center gap-6'>
                    <div className='hidden items-center gap-5 text-sm text-slate-500 md:flex'>
                        ...
                        {isAdmin && <Link to='/admin' className='whitespace-nowrap transition hover:text-slate-900'>Admin Dashboard</Link>}
                    </div>
            ...
            <div className='sticky top-[76px] border-t border-slate-200 bg-white/95 px-4 py-2 backdrop-blur lg:hidden'>
                <div className='mb-1.5 flex items-center justify-between'>
                    <p className='text-[11px] font-semibold uppercase tracking-[0.24em] text-emerald-500'>Workspace</p>
                    <p className='text-xs font-medium text-slate-400'>{pageNames[location.pathname] || 'Owner Panel'}</p>
                </div>
