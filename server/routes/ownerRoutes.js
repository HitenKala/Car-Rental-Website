...
ownerRouter.post("/change-role", protect, validateMultipart, upload.any(), changeRoleToOwner);
ownerRouter.post("/add-car", protect, validateMultipart, upload.any(), addCar);
ownerRouter.get("/cars", protect, getOwnerCars);
ownerRouter.post("/toggle-car", protect, toggleCarAvailability);
ownerRouter.post("/delete-car", protect, deleteCar);
ownerRouter.post("/update-car", protect, validateMultipart, upload.any(), updateCarDetails);
